...
class BacktestMetrics(BaseModel):
    ...
    ulcer_index: Optional[float] = 0.0
    max_drawdown: Optional[float] = 0.0
    max_drawdown_pct: Optional[float] = 0.0
    average_drawdown_pct: Optional[float] = 0.0
    max_drawdown_duration: int = 0
    average_win: Optional[float] = 0.0
    average_loss: Optional[float] = 0.0
    average_trade: Optional[float] = 0.0
    payoff_ratio: Optional[float] = 0.0
    expectancy: Optional[float] = 0.0
    expectancy_r: Optional[float] = 0.0
    total_pnl: Optional[float] = 0.0
    total_pnl_pct: Optional[float] = 0.0
    annual_return: Optional[float] = 0.0
    annualized_volatility: Optional[float] = 0.0
